     ...
     <Navbar/>
      ...
      <div className="container mx-auto">
        ...
        <div className="flex items-center justify-center w-full">
            <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-900 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-[#121212] dark:bg-[#212121] hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                ...
                <input id="dropzone-file" type="file" className="hidden" onInput={(event) => handleUpload(event)}/>
            </label>
        </div> 
      <p>Selected file: {uploadName}</p>
